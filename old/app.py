...
def answer_local(q: str, patient: str, k: int = 4):
    ...
    for d in hits:
        ...
        serial_hits.append({"metadata": meta, "page_content": txt})
...
- Use APENAS as informações do CONTEXTO (materiais indexados) quando possível.
- Se o contexto não trouxer evidência suficiente, diga claramente o que faltou e sugira o que consultar.
- Seja objetivo, com passos práticos quando fizer sentido.
- Evite inventar números, protocolos ou condutas.
