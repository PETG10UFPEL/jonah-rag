...
<style>
  ...
  .stApp {
    background: linear-gradient(180deg, #fffaf7 0%, #f8fbff 55%, #ffffff 100%);
  }
  ...
  .inst-bar {
    ...
    gap:14px;
    flex-wrap:wrap;
    background: linear-gradient(90deg, rgba(239,68,68,.10), rgba(245,158,11,.10), rgba(96,165,250,.14));
  ...
  .badge-red { background: var(--pel-red); }
  .badge-orange { background: var(--pel-orange); }
  .badge-blue { background: var(--pel-blue-dark); }
  ...
  .stButton > button[kind="primary"] {
    background: linear-gradient(90deg, var(--pel-red), var(--pel-orange)) !important;
    color: white !important;
  ...
  .stDownloadButton > button {
    ...
    color: var(--pel-blue-dark) !important;
...
<div class="inst-bar">
  <div>
    <p class="inst-title">Guia de Feridas Crônicas</p>
    <div style="display:flex; align-items:center; gap:14px; flex-wrap:wrap; font-size:0.95rem; margin-top:0.35rem;">
      {insta_tag}
      <a href="https://www.instagram.com/amorapele_ufpel/" target="_blank"
         style="text-decoration:none; font-weight:600; color:#2563eb;">Amor à Pele</a>
      <span style="color:#94a3b8;">|</span>
      <a href="https://www.instagram.com/g10petsaude/" target="_blank"
         style="text-decoration:none; font-weight:600; color:#2563eb;">PET G10</a>
      <span style="color:#94a3b8;">|</span>
      {enf_tag}
      <a href="https://wp.ufpel.edu.br/fen/" target="_blank"
         style="text-decoration:none; font-weight:600; color:#2563eb;">Faculdade de Enfermagem – UFPel</a>
    </div>
  </div>
  <div class="inst-badges">
    <span class="inst-badge badge-red">Portal Educação</span>
    <span class="inst-badge badge-orange">Portal Cultura</span>
    <span class="inst-badge badge-blue">Portal Saúde</span>
  </div>
</div>
""", unsafe_allow_html=True)
...
<div class="main-card">
  ...
  <p class="info-text" style="margin-top:0.2rem; margin-bottom:0;">
